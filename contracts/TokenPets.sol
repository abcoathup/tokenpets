 ...
 */
contract TokenPets is ERC165, ERC721, ERC721Enumerable, IERC721Metadata, MinterRole {
    ...
    constructor () public {
        _name = "TokenPets";
        _symbol = "PET";
        _baseTokenURI = "https://abcoathup.github.io/tokenpets/apisampledata/tokenpet/";
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        require(_exists(tokenId), "TokenPets: URI query for nonexistent token");
